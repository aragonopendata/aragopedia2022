...
export class FichaAragonComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.resultSvc.getData(this.queryNombresIne).subscribe(data => {
      ...
      this.queryUrlMiembrosPleno = `https://opendata.aragon.es/sparql?default-graph-uri=&query=prefix+org%3A+%3Chttp%3A%2F%2Fwww.w3.org%2Fns%2Forg%23%3E%0D%0Aprefix+ei2av2%3A+%3Chttp%3A%2F%2Fopendata.aragon.es%2Fdef%2Fei2av2%23%3E%0D%0A%0D%0Aselect+distinct+%3Forg+%3ForgTitle+%3Fpersona+%3Fnombre%0D%0Afrom+%3Chttp%3A%2F%2Fopendata.aragon.es%2Fdef%2Fei2av2%3E+where+%7B%0D%0A+++%3Forg+%3Fp+%3Fo%3B%0D%0A+++ei2av2%3Alegislature+%3Chttp%3A%2F%2Fopendata.aragon.es%2Frecurso%2Fsector-publico%2Flegislatura%2F26%3E%3B%0D%0A+++dc%3Atitle+%3ForgTitle%3B%0D%0A++ei2av2%3Aorder+%3Forder.%0D%0A++%3Fcargo+org%3ApostIn+%3Forg+%3B%0D%0A+++++++++%3Chttp%3A%2F%2Fopendata.aragon.es%2Forder%3E+%221%22%5E%5E%3Chttp%3A%2F%2Fwww.w3.org%2F2001%2FXMLSchema%23int%3E.%0D%0A%0D%0A++%3Fpersona+org%3Aholds+%3Fcargo%3B%0D%0A+++++++foaf%3Aname+%3Fnombre.%0D%0A%0D%0A+++FILTER+NOT+EXISTS+%7B+%3Forg+org%3AsubOrganizationOf+%3Fx%7D%0D%0A+%7D%0D%0Aorder+by+%3Forder&format=application%2Fsparql-results%2Bjson&timeout=0&signal_void=on`;
